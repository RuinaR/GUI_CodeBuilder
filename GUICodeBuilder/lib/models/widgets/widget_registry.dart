...
final widgetDefinitions = <WidgetDefinition>[
  ...
  SimpleWidgetDefinition(
      ...
      properties: const [
        WidgetPropertyDefinition(
            key: 'text', label: 'text', kind: WidgetPropertyKind.multilineText),
  ...
  SimpleWidgetDefinition(
      ...
      properties: const [
        WidgetPropertyDefinition(
            key: 'title', label: 'title', kind: WidgetPropertyKind.text),
        ...commonBoxProperties
      ],
      propsBuilder: (id) => baseProps(id)
        ..addAll({'title': 'Group', 'backgroundColor': '#F8FAFC'})),
  SimpleWidgetDefinition(
      typeId: 'tabs',
      label: 'Tab widget',
      description: '탭 컨테이너',
...
WidgetDefinition definitionFor(String typeId) {
  return widgetDefinitions.firstWhere(
    ...
    orElse: () => widgetDefinitions
        .firstWhere((definition) => definition.typeId == 'container'),
  );
}
